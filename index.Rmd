...
ERPI <- ERPI %>% select(Year,Type.document , Title, Authors, DOI, Journal, 'Scimago<br/>Engineering', 'Scimago<br/>Decision<br/>Sciences' , Publisher, Conference,Language ,  Url)
...
ERPI %>% select(Year, Type.document, Title, Authors, Journal, 'Scimago<br/>Engineering', 'Scimago<br/>Decision<br/>Sciences') %>% 
