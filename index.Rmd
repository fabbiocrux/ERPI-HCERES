...
## Engineering
Engineering.Scimago <- read.csv2("HAL/Scimago/Engineering.csv") %>%  select(Title, SJR.Best.Quartile)
Engineering.Scimago <-  Engineering.Scimago %>% set_names("Journal", "Scimago.Engineering")
Engineering.Scimago$Journal = tolower(Engineering.Scimago$Journal)


## Decision Science
DS.Scimago <- read.csv2("HAL/Scimago/Decision-sciences.csv") %>%  select(Title, SJR.Best.Quartile)
DS.Scimago <-  DS.Scimago %>% set_names("Journal", "Scimago.Decision.Sciences")
...
ERPI <- ERPI %>% select(Year,Type.document , Title, Authors, DOI, Journal, Scimago.Engineering, Scimago.Decision.Sciences  , Publisher, Conference,Language ,  Url)
...
ERPI %>% select(Year, Type.document, Title, Authors, Journal, Scimago.Engineering, Scimago.Decision.Sciences) %>% 
